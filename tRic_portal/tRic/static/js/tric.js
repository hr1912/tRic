...
var tric=(function(){
    ...
    function load_subtype() {
        $("#select_dataset").on('change', function () {
            ...
            var url = '/api/subtype/' + dataset_id;
    ...
    function buildLoadDataTableCallback(obj){
        ...
        return function(error, data){
            ...
            var tmpl_id = 'tab_' + analysis, table_tmpl = '/trna/' + table_id;
            ...
            $("#"+tmpl_id).load(table_tmpl, function(){
                ...
                if(analysis == "tm_comparison"){
                    var img_path = '/trna/tm_comparison_table/png/' + data.png_name;
                    var img = '<img src="' + img_path + '" style="width:80%;height:80%" onerror="this.src=\'/static/image/error.svg\'">';
                    setTimeout(function(){
    ...
    function check_input_autocomplete(module){
        ...
        $(selector).autocomplete({
            ...
            source: function(request, response){
                var url = '/api/list/' + module  + "/" + request.term.trim();
                $.getJSON(
                    url,
                    function(data){
                        response(data);
